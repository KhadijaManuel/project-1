<template>
  <div class="flex min-h-screen bg-gray-100">
    ...
    <main class="flex-1 p-8">
      <!-- Page Title -->
      <h2 class="text-3xl font-bold mb-6 text-blue-700">Leave Management</h2>

      <!-- Filter Buttons -->
      <div class="mb-6">
        <h5 class="text-lg font-semibold mb-2 text-gray-700">Filter by Status:</h5>
      ...
      <div class="flex justify-center mt-10">
        <div class="bg-white shadow-md rounded-lg p-6 w-full max-w-xl">
          <h3 class="text-xl font-semibold mb-4 text-gray-800">New Leave Request</h3>
